...
/**
 * The test class MoveVerticallyTest.
 * 
 * Test Conditions
 * 
 * 1) Construction: all fields are initialised as expected and checked once via the object bench using the Initialise method
 * 2) update(): check that the update method increments the y position of the IBehaviour
 * 3) componantAction(): check that the method changes the _vector field correctly and the y position now decrements
 *
 * @author  Chris Williams
 * @version 3.0
 */
public class MoveVerticallyTest
{
    /**
     * Default constructor for test class MoveVerticallyTest
     */
    public MoveVerticallyTest()
    {
    }
     ...
     * Check if the update method increments the y position of the IBehaviour
     * 
     */
    @Test
    public void testCondition2()
    {
        ...
        // DECLARE and initialise an instance of the MoveVertically class, call it '_mVertical':
        IComponent _mVertical = new MoveVertically();
        ...
        // CALL the IComponent method update to see if the token's y position is incremented:
        _mVertical.update();
        ...
        if(_startPos[1] == _rtnPos[1])
        {
            // FAILED to increment the y position:
            fail("The y position hasn't been incremented");
        }
     ...
     * Check if the componentAction method changes the vector field and the y position of the IBehaviour now decrements
     * 
     */
    @Test
    public void testCondition3()
    {
        ...
        _mVertical.componentAction();
        
        // CALL the update method of the IComponent to decrement to y position:
        _mVertical.update();
        ...
        if(_startPos[1] <= _rtnPos[1])
        {
            ...
            System.out.println("Start: " + _startPos[1] + " Return: " + _rtnPos[1]);
            fail("The y position hasn't been decremented by changing the vector");
