...
/**
 * The test class BubbleTest for testing the Bubble production class.
 *
 ...
 * 2: Construction: check that the method setScale(0.05) sets the scale of the bubble to 0.05 in token
...
public class BubbleTest
{
     ...
     * setScale(0.05) check that this method sets the scale of the bubble to 0.05 in token
     * 
     */
    @Test
    public void testCondition2()
    {
        ...
        // CREATE a new token with the Bubble texture and 'sphere' model:
        try
        {
            _token = new Token("textures/javaFish/Bubble.png", "sphere");
        }
        ...
        // DECLARE and initialise an instance of Bubble, call it '_bubble' with a position in the middle of the screen:
        IBehaviour _bubble = new Bubble(_token,5.0,5.0);
