...
/**
 * The test class PiranhaTest for testing the Piranha production class.
 *
...
public class PiranhaTest
{
    ...
    public void testCondition3()
    {
        ...
        // CORRECT use of throw tested in token:
        // CREATE a new instance of Token in the _token field with a PiranhaRed texture:
        try
        {
            _token = new Token("textures/javaFish/PiranhaRed.png");
        }
        ...
        // DECLARE and initialise a double from calling the _piranha.getPosition method to get the current y position, call it '_posY'::
        double _posY = _piranha.getPosition()[1];
